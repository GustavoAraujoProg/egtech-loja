        ...
        <div className="bg-zinc-50 min-h-[85vh] flex items-center justify-center px-4 py-12">
            <div className="w-full max-w-md bg-white p-8 sm:p-10 rounded-3xl shadow-xl shadow-zinc-200/50 border border-zinc-100 animate-fadeIn">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-black text-zinc-900 tracking-tight">Crie sua conta</h1>
                    <p className="text-zinc-500 mt-2 text-sm">Rápido, fácil e 100% seguro.</p>
                </div>
                ...
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-xs font-medium text-zinc-400 uppercase tracking-wider">Ou use o e-mail</span>
                    <div className="flex-1 h-px bg-zinc-200"></div>
                </div>
                ...
                {/* Sem pedir CEP ou CPF aqui! Isso fica pra hora do checkout. */}
                <form action={formAction} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={pending}
                        className="w-full bg-blue-600 text-white font-bold py-4 rounded-xl hover:bg-blue-700 transition-colors shadow-lg shadow-blue-200 cursor-pointer mt-4 disabled:opacity-60"
                    >
                        {pending ? 'Criando conta...' : 'Criar Conta'}
                    </button>

                    <p className="text-xs text-center text-zinc-400 mt-2">
                        Ao se cadastrar, você concorda com nossos <Link href="/termos" className="underline hover:text-zinc-600">Termos</Link> e <Link href="/privacidade" className="underline hover:text-zinc-600">Privacidade</Link>.
                    </p>
                </form>
